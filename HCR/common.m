...
% 装置尺寸
pro.NumOfBed.Reactor1=2;% 加氢精制反应器床层数
pro.NumOfBed.Reactor2=3;% 加氢裂化反应器床层数
...
% 平均分子质量Mn(g/mol)
% 1VNA 2HNA 3MNA 4VN 5HN 6MN 7LN 8VA 9HA 10MA 11LA 12VP 13HP 14MP 15LP 16VS
% 17HS 18MS 19LS 20VNI 21HNI 22MNI 23LNI 24L
...
heat=60000;
pro.heat_HCR1=[heat heat]'.*heat_HCR1index;% J/mol
pro.heat_HCR2=[heat heat heat]'.*heat_HCR2index;
