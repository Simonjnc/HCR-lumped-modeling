...
%%%%%%%%%%%%%%%%%%%%%%
YandT_mea(1:5) = k2t(opr.T_Input);
YandT_mea(6:10)= k2t(opr.T_Output);
YandT_mea(11:34)= 100*opr.Ym;
...
%     W=[ones(1,7) 20*ones(1,6)]; % 权值,暂时不对父函数开放
    fun=sum( ( (YandT(6:34)-YandT_mea(6:34)).*OBJparameter.Weight ).^2 );
elseif OBJparameter.AoR=='R' % 相对误差
    fun=sum( ( ( ( YandT(6:34)-YandT_mea(6:34) )./YandT_mea(6:34) ).*OBJparameter.Weight ).^2 );
end
fun=sqrt(fun/size(YandT(6:34),2));
