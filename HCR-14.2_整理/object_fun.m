...
%     W=[ones(1,7) 20*ones(1,6)]; % 权值,暂时不对父函数开放
    fun=sum( ( (YandT(8:20)-YandT_mea(8:20)).*OBJparameter.Weight ).^2 );
elseif OBJparameter.AoR=='R' % 相对误差
    fun=sum( ( ( ( YandT(8:20)-YandT_mea(8:20) )./YandT_mea(8:20) ).*OBJparameter.Weight ).^2 );
end
fun=sqrt(fun/size(YandT(8:20),2));
